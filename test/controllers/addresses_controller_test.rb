...
class AddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create address" do
    assert_difference("Address.count") do
      post addresses_url, params: { address: { city: @address.city, end_date: @address.end_date, label: @address.label, person_id: @address.person_id, start_date: @address.start_date, state: @address.state, street: @address.street, zipcode: @address.zipcode } }
    end
