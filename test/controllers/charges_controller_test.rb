...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference("Charge.count") do
      post charges_url, params: { charge: { description: @charge.description, invoice_id: @charge.invoice_id, price: @charge.price } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { description: @charge.description, invoice_id: @charge.invoice_id, price: @charge.price } }
